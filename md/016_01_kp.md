...
Minden karakter minden Tapasztalati-szinten további `(20 + Emlékezet) KP` javadalmazást kap, amely kizárólag olyan ismeretekre fordítható, amelyek a [Szekunder ismeretek](015_primer_szekunder_ismeretek.md) csoportjába tartoznak.
...
⚜️ **[Képzettségek](030_kepzettsegrendszer.md)**: [KP igényük](035_kepzettsegszintek_kp_igenye.md)
