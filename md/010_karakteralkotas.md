...
Folytatásként a 8 [Tulajdonságod](014_tulajdonsagok.md) értékét kell meghatároznod `[-5; 5]` intervallumban **Tulajdonságpontok** elosztásával, majd a [Karakteralkotó Pontjaid](017_02_kp.md) (`KP`) kiszámolása következik, amelyekből különböző ismereteket vehetsz amjd fel. Figyelj, hogy a [Szekunder KP](017_02_kp.md)-kat csak [Szekunder ismeretekre költheted](016_primer_szekunder_ismeretek.md).
