...
Egy egyszerű paraszt öregkorára elérheti a `3-4.` tapasztalati szintet is. Ez persze nem jár automatikus harcérték emelkedéssel, hiszen a `km100` rendszerében csak az nő, amire költünk. Kivétel ez alól a Tudatalatti Mágiaellenállás (`TME`) ⭕TODO: link⭕, amely a tapasztalattal és korral lassan magától nő.
