...
| ⭕Hosszú íj       | kétkezes       |     |     ``       |        |     | `+12` |   `3`    |  `120m`   |          | Az Erőbónusz csak akkor számít ha az íj erre az Erő értékre lett tervezve!                         |     |
| ⭕Visszacsapó íj  | kétkezes       |     |     ``       |        |     | `+10` |   `3`    |  `160m`   |          | Az Erőbónusz csak akkor számít ha az íj erre az Erő értékre lett tervezve!                         |     |
| ⭕Elf íj          | kétkezes       |     |     ``       |        |     | `+13` | `3(4\*)` |  `120m`   |          | \Csak a készítője (és egyben birtokosa) kezében, egyébként hagyományos íjként működik és Osztója: `3`. |     |
| ⭕Fúvócső, kicsi  | egykezes       |     |    spec\*    |        |     | `+8`  |   `1`    |    `16m`  |          | \* `k20` dobásnál: `20`-as dobás: `1 ÉP`, különben `0 ÉP`                                             |     |
| ⭕Fúvócső, vadász | kétkezes       |     |     ``       |        |     | `+10` |   `1`    |   `30m`   |          |                                                                                                    |     |
